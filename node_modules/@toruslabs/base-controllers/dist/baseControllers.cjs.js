...
function createCommunicationMiddleware(providerHandlers) {
  ...
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.mergeMiddleware)([createChangeProviderMiddlewareMiddleware({
    ...
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.SHOW_WALLET_CONNECT]: showWalletConnect,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.SHOW_CHECKOUT]: showCheckout,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.SHOW_WALLET_UI]: showWalletUi,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.WINDOW_BLOCKED]: showWindowBlockAlert
...
class BaseKeyringController extends _BaseController__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z {
  ...
  async signAuthMessage(address, message) {
    ...
    const rawMessageSig = await (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .signMessage */ .l)(keyring.privateKey, hashedMessage);
...
class BasePreferencesController extends BaseController/* default */.Z {
  ...
  async init(address, userInfo, jwtToken) {
    ...
    if (!jwtToken) {
      ...
      if (!messageToSign.startsWith(this.config.signInPrefix)) throw new Error("Cannot sign on invalid message");
      const signedMessage = await this.signAuthMessage(address, messageToSign);
      response = await (0,http_helpers_namespaceObject.post)(`${this.config.api}/auth/verify`, objectSpread2_default()({
        public_address: address,
        signed_message: signedMessage,
